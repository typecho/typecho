    ...
    public function execute()
    {
        ...
        $childNodes = array(
            ...
            array(
                ...
                array(
                    array('Widget_Plugins_Config', 'getMenuTitle'),
                    array('Widget_Plugins_Config', 'getMenuTitle'),
                    'options-plugin.php?config=',
                    'administrator',
                    true
                ),
                array(_t('外观'), _t('网站外观'), 'themes.php', 'administrator'),
                array(
                    array('Widget_Themes_Files', 'getMenuTitle'),
                    array('Widget_Themes_Files', 'getMenuTitle'),
                    'theme-editor.php',
                    'administrator',
                    true
            ...
            array(
                ...
                array(
                    array('Widget_Contents_Post_Edit', 'getMenuTitle'),
                    array('Widget_Contents_Post_Edit', 'getMenuTitle'),
                    'write-post.php?cid=',
                    'contributor',
                    true
                ...
                array(
                    array('Widget_Contents_Page_Edit', 'getMenuTitle'),
                    array('Widget_Contents_Page_Edit', 'getMenuTitle'),
                    'write-page.php?cid=',
                    'editor',
                    true
            ...
            array(
                ...
                array(
                    array('Widget_Contents_Post_Admin', 'getMenuTitle'),
                    array('Widget_Contents_Post_Admin', 'getMenuTitle'),
                    'manage-posts.php?uid=',
                    'contributor',
                    true
                ),
                ...
                array(
                    array('Widget_Comments_Admin', 'getMenuTitle'),
                    array('Widget_Comments_Admin', 'getMenuTitle'),
                    'manage-comments.php?cid=',
                    'contributor',
                    true
                ),
                ...
                array(
                    array('Widget_Metas_Category_Admin', 'getMenuTitle'),
                    array('Widget_Metas_Category_Admin', 'getMenuTitle'),
                    'manage-categories.php?parent=',
                    'editor',
                    true,
                    array('Widget_Metas_Category_Admin', 'getAddLink')
                ),
                array(
                    array('Widget_Metas_Category_Edit', 'getMenuTitle'),
                    array('Widget_Metas_Category_Edit', 'getMenuTitle'),
                    'category.php?mid=',
                    'editor',
                    true
                ...
                array(
                    array('Widget_Metas_Tag_Admin', 'getMenuTitle'),
                    array('Widget_Metas_Tag_Admin', 'getMenuTitle'),
                    'manage-tags.php?mid=',
                    'editor',
                    true
                ...
                array(
                    array('Widget_Contents_Attachment_Edit', 'getMenuTitle'),
                    array('Widget_Contents_Attachment_Edit', 'getMenuTitle'),
                    'media.php?cid=',
                    'contributor',
                    true
                ...
                array(
                    array('Widget_Users_Edit', 'getMenuTitle'),
                    array('Widget_Users_Edit', 'getMenuTitle'),
                    'user.php?uid=',
                    'administrator',
                    true
    ...
    public function output($class = 'active', $childClass = 'active')
    {
        foreach ($this->_menu as $key => $node) {
            ...
            echo "<li class=\"nav-item\">
					<a class=\"nav-link\" href=\"{$node[2]}\">{$node[0]} <span class=\"arrow\"></span></a>
					<nav class=\"nav\">";
...
//                . "</li><ul class=\"child\">";
            ...
            foreach ($node[3] as $inKey => $inNode) {
                ...
                echo "<a class=\"nav-link" . (!empty($classes) ?  ' ' . implode(' ', $classes) : NULL) . " \" href=\"" . ($key == $this->_currentParent && $inKey == $this->_currentChild ? $this->_currentUrl : $inNode[2]) . "\">{$inNode[0]}</a>";
            }
