...
class Widget_Options_Discussion extends Widget_Abstract_Options implements Widget_Interface_Do
{
    ...
    public function form()
    {
        ...
        _t('评论日期格式'), _t('这是默认的格式，在模板中调用显示评论日期方法时，如果没有指定日期格式，将按照此默认格式输出。') . '<br />'
        ...
        $commentsShowOptions = array(
            ...
            'commentsUrlNofollow'   =>  _t('对评论者个人主页链接使用 <a href="https://en.wikipedia.org/wiki/Nofollow">nofollow</a> 属性'),
            ...
            'commentsPageBreak'     =>  _t('启用分页（每页显示 %s 篇评论，在列出时将 %s 作为默认显示）',
        ...
        _t('允许使用的 HTML 标签和属性'), _t('用户评论默认不允许包含任何 HTML 标签，可以在这里填写例外允许使用的 HTML 标签。') . '<br />'
