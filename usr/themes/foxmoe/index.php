...
<main class="main-container">
    <section class="hero-banner" id="home">
        <div class="hero-background">
            <img src="" data-src="https://www.dmoe.cc/random.php" referrerpolicy="no-referrer" alt="Hero"
                class="hero-bg-img lazy-hero" decoding="async" loading="lazy" fetchpriority="low">
        </div>
                        ...
                        <article class="post-card" data-url="<?php $this->permalink(); ?>">
                            <div class="post-image-wrapper">
                                ...
                                <div class="post-content">
                                    <h3 class="post-title"><a href="<?php $this->permalink(); ?>"
                                            class="post-title-link"><?php $this->title(); ?></a></h3>
                                    <p class="post-excerpt">
                                        <?php echo mb_substr(strip_tags($this->markdown($this->excerpt)), 0, 120, 'UTF-8') . '...'; ?>
                                    </p>
                                    <div class="post-meta">
                                        <div class="post-author">
                                            <img src="<?php $this->options->themeUrl('image/logo/640.png'); ?>"
