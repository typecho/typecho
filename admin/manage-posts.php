                    ...
                    <table class="typecho-list-table">
                        ...
                        <tbody>
                            ...
                            <tr id="<?php $posts->theId(); ?>">
                                ...
                                <td><a href="<?php $options->adminUrl('manage-comments.php?cid=' . $posts->cid); ?>" class="balloon-button size-<?php echo Typecho_Common::splitByCount($posts->commentsNum, 1, 10, 20, 50, 100); ?>" title="<?php _e('查看评论'); ?>"><?php $posts->commentsNum(); ?></a></td>
                                <td>
