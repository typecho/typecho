...
$(document).ready(function () {
    ...
    $('.operate-edit').click(function () {
        ...
        var edit = $('<tr class="comment-edit"><td> </td>'
                        ...
                        + '<p><label for="' + id + '-author"><?php _e('用户名'); ?></label><input class="text-s" id="'
                        + id + '-author" name="author" type="text"></p>'
                        + '<p><label for="' + id + '-mail"><?php _e('电子邮箱'); ?></label>'
                        + '<input class="text-s" type="email" name="mail" id="' + id + '-mail"></p>'
                        + '<p><label for="' + id + '-url"><?php _e('个人主页'); ?></label>'
                        + '<input class="text-s" type="text" name="url" id="' + id + '-url"></p></form></td>'
