    ...
    <div class="typecho-login">
        ...
        <form action="<?php $options->loginAction(); ?>" method="post" name="login" role="form">
            <p>
                ...
                <input type="text" id="name" name="name" value="<?php echo $rememberName; ?>" placeholder="<?php _e('用户名或邮箱'); ?>" class="form-lg" autofocus />
            </p>
            <p>
                <label for="password" class="sr-only"><?php _e('密码'); ?></label>
                <input type="password" id="password" name="password" class="form-lg" placeholder="<?php _e('密码'); ?>" required />
            </p>
            <p class="submit">
                <button type="submit" class="btn btn-lg w-100 btn-primary"><?php _e('登录'); ?></button>
