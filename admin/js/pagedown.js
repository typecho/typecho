...
(function () {
    ...
    Markdown.Editor = function (markdownConverter, idPostfix, options) {
        ...
        this.run = function () {
            ...
            var previewManager = new PreviewManager(markdownConverter, panels,
                function (text) { return hooks.postMarkdown(text); }, function () { hooks.onPreviewRefresh(); });
    ...
    function PreviewManager(converter, panels, previewMarkdownFilter, previewRefreshCallback) {
        ...
        var makePreviewHtml = function () {
            ...
            text = previewMarkdownFilter(converter(text));
