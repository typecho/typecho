...
<section id="custom-field"
            ...
            <tr>
                <td>
                    ...
                    <input type="text" name="fieldNames[]" value="<?php echo htmlspecialchars($field['name']); ?>"
                           id="fieldname" pattern="^[_a-zA-Z][_a-zA-Z0-9]*$" oninput="this.reportValidity()" class="form-sm">
                </td>
                <td>
                ...
                <td>
                    ...
                    <textarea name="fieldValues[]" id="fieldvalue" class="form-sm"
            ...
            <tr>
                <td>
                    ...
                    <input type="text" name="fieldNames[]" placeholder="<?php _e('字段名称'); ?>" id="fieldname"
                           class="form-sm" pattern="^[_a-zA-Z][_a-zA-Z0-9]*$" oninput="this.reportValidity()">
                </td>
                <td>
                    <label for="fieldtype" class="sr-only"><?php _e('字段类型'); ?></label>
                    <select name="fieldTypes[]" id="fieldtype" class="form-sm">
    ...
    <div class="description d-flex align-items-center justify-content-between">
        ...
        <span><?php _e('自定义字段可以扩展你的模板功能, 使用方法参见 <a href="https://docs.typecho.org/help/custom-fields">帮助文档</a>'); ?></span>
    </div>
</section>
